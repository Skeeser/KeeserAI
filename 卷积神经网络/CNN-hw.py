...
batch_size = 256
train_iter, test_iter = ld.load_data_mnist(batch_size=batch_size)
...
class LeNet:
    ...
    def train_ch6(self, net, train_iter, test_iter, num_epochs, lr, device):
        """用GPU训练模型"""
        def init_weights(m):
    ...
    def run(self):
        # self.check()
        lr, num_epochs = 0.006, 10
        self.train_ch6(self.net, train_iter, test_iter, num_epochs, lr, d2l.try_gpu())
        d2l.plt.show()
